...
- Un área principal (`<main>`) dividida en:
  ...
  - Panel de *Insights* (alertas inteligentes de ahorro o aumento de gastos).
...
- **Clases para UI:**
  ...
  - Estilos semánticos para los *insights* (borde izquierdo rojo, verde o azul).
...
- **Exportar (`exportToExcel`)**:
  ...
  - Inserta debajo del subtotal las frases del *insight* en la hoja de Excel, fusionando celdas e italicizándolas.
