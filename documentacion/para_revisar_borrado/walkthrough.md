...
*   **Componente Creado [NEW]:** [src/components/CalendarWidget.js](file:///c:/Users/Desktop/OneDrive/Desktop/Git%20Hub/Gestion-de-servicios/src/components/CalendarWidget.js)
    ...
    *   *Nota de MVP:* Por decisión arquitectónica, el widget se ha desactivado (comentado) en la interfaz para concentrar el MVP en el listado ordenado y evitar sobrecargas visuales. Se conserva en la base de código para reactivación posterior.
...
*   **Selector Segmentado:** En `ServiceForm.js`, se inyectó la pregunta *¿Quién pagó este servicio?* con opciones *Yo* (`SELF`) y *Otra persona* (`THIRD_PARTY`), acompañada del texto aclaratorio.
